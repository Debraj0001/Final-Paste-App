...
const Home = () => {
  ...
  return (
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0 bg-gradient-to-r from-blue-700 to-green-700">
      <div className="flex flex-col items-start gap-y-5 ">
        <div className="flex flex-row items-center justify-between w-full gap-x-4 ">
          ...
          />
          <button
            className="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
            onClick={createPaste}
          >
